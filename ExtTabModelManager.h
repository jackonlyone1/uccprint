...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	// Insert Tab Ext2, Inserts a child object at the given index..
	// This member function is also a virtual function, you can Override it if you need,  
	//		Returns a pointer to the object CFOTabPageModel,or NULL if the call failed  
	// Parameters:
	//		CFOTabPageModel*pModel---F O Tab Page Model*p Model, A pointer to the CFOTabPageModel or NULL if the call failed.
	virtual CFOTabPageModel* InsertTabExt2(CFOTabPageModel*pModel);

	
	//-----------------------------------------------------------------------
	// Summary:
	// Fill In Field Print, None Description.
	//		Returns TRUE on success; FALSE otherwise.  
	// Parameters:
	//		nLabelIndex---Label Index, Specifies A integer value.
	BOOL FillInFieldPrint(int nLabelIndex);
	
	//-----------------------------------------------------------------------
	// Summary:
	// Search For All E Form Shapes, None Description.
	// This member function is also a virtual function, you can Override it if you need,
	virtual void SearchForAllEFormShapes();
	
	//-----------------------------------------------------------------------
	// Summary:
	// Reset All E Form Shapes, Called this function to empty a previously initialized CExtTabModelManager object.
	// This member function is also a virtual function, you can Override it if you need,
	virtual void ResetAllEFormShapes();
	
	//-----------------------------------------------------------------------
	// Summary:
	// Reset All E Form Shapes2, Called this function to empty a previously initialized CExtTabModelManager object.
	// This member function is also a virtual function, you can Override it if you need,
	virtual void ResetAllEFormShapes2();
	
	//-----------------------------------------------------------------------
	// Summary:
	// Do Back D B Name, Do a event. 
	// This member function is also a virtual function, you can Override it if you need,
	virtual void DoBackDBName();
	
	//-----------------------------------------------------------------------
	// Summary:
	// Save Table Data, Call this function to save the specify data to a file.
	// Parameters:
	//		*pTable---*pTable, A pointer to the CFOPTableShape  or NULL if the call failed.
	void SaveTableData(CFOPTableShape *pTable);
	
	//-----------------------------------------------------------------------
	// Summary:
	// Restore Table Data, None Description.
	// Parameters:
	//		*pTable---*pTable, A pointer to the CFOPTableShape  or NULL if the call failed.
	void RestoreTableData(CFOPTableShape *pTable);
	
	//-----------------------------------------------------------------------
	// Summary:
	// Restore Table Data2, None Description.
	// Parameters:
	//		*pTable---*pTable, A pointer to the CFOPTableShape  or NULL if the call failed.
	void RestoreTableData2(CFOPTableShape *pTable);
	...
	// Parameters:
	//		*pTable---*pTable, A pointer to the CFOPTableShape  or NULL if the call failed.
	void SaveTableData(FOXNewTableShape *pTable);
	...
	// Parameters:
	//		*pTable---*pTable, A pointer to the CFOPTableShape  or NULL if the call failed.
	void RestoreTableData(FOXNewTableShape *pTable);
	...
	// Parameters:
	//		*pTable---*pTable, A pointer to the CFOPTableShape  or NULL if the call failed.
	void RestoreTableData2(FOXNewTableShape *pTable);
// Implementation

 
	// All Form Shapes, This member specify E-XD++ CFODrawShapeList object.  
	CFODrawShapeList listAllFormShapes;
	...
	// Record Postion, This variable specifies a 32-bit signed integer on 32-bit platforms.  
	int	m_nRecordPostion;
	//
 
	// Total Record, This variable specifies a 32-bit signed integer on 32-bit platforms.  
	int m_nTotalRecord;
public:
#ifdef _DEBUG
...
public:
	...
	// Label2 Record, This member specify CMapIntToInt object.  
	CMapIntToInt m_mapLabel2Record;
  
	// Index2 Offset, This member specify CMapIntToInt object.  
	CMapIntToInt m_mapIndex2Offset;
	
	//-----------------------------------------------------------------------
	// Summary:
	// Begin Print, None Description.

	void BeginPrint();
	
	//-----------------------------------------------------------------------
	// Summary:
	// End Print, None Description.

	void EndPrint();
	
	//-----------------------------------------------------------------------
	// Summary:
	// Get Print Count, Returns the specified value.
	//		Returns a int type value.
	int GetPrintCount();
	
	//-----------------------------------------------------------------------
	// Summary:
	// Get Print Page Count, Returns the specified value.
	//		Returns a int type value.
