...
/* get a string */
bool  RegValGetString (const RegVal *pValData, CString &sString);

/* get an array of strings */
bool  RegValGetStringArr (const RegVal *pValData, CStringArray &arrString);
...
/* set an array of strings */
bool  RegValSetStringArr (RegVal *pValData, const CStringArray &arrString);
...
/* load a string */
bool  RegLoadString (HKEY hKey, LPCTSTR pszSubKey, LPCTSTR pszValName, CString &sString);

/* load an array of strings */
bool  RegLoadStringArr (HKEY hKey, LPCTSTR pszSubKey, LPCTSTR pszValName, CStringArray &arrString);
...
/* store an array of strings */
bool  RegSaveStringArr (HKEY hKey, LPCTSTR pszSubKey, LPCTSTR pszValName, const CStringArray &arrString);
